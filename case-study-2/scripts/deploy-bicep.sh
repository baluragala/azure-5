#!/usr/bin/env bash
# ============================================================
# Case Study 2 — 3-Tier Network Security Deployment (Bicep)
# FinTrust Bank: NSGs, ASGs, UDRs
#
# Usage:
#   ./deploy-bicep.sh [resource-group] [prefix] [location]
#
# Examples:
#   ./deploy-bicep.sh
#   ./deploy-bicep.sh rg-fintrust-prod fintrust eastus
# ============================================================
...
BICEP_FILE="${SCRIPT_DIR}/../bicep/network-security.bicep"
...
# ---- Step 3: Deploy ----
DEPLOYMENT_NAME="fintrust-bicep-$(date +%Y%m%d-%H%M%S)"
print_step "Deploying 3-tier security infrastructure via Bicep (${DEPLOYMENT_NAME})..."
...
echo ""
print_ok "FinTrust Bank 3-tier security deployment (Bicep) successful!"
echo ""
echo "Next steps:"
